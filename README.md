Ниже представлен полный отформатированный документ `README.md` (или аналогичный) с улучшенной структурой, таблицами и чётким выделением ключевых разделов. Весь смысл сохранён, но читаемость и навигация значительно улучшены.
